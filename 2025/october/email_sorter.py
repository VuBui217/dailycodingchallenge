"""
Link to problem: https://www.freecodecamp.org/learn/daily-coding-challenge/2025-10-29
...
def sort(emails):
    ...
    # emails.sort(key=lambda email: (email.split('@')[1].lower(), email.split('@')[0].lower()))
    # return emails
    # using sorted()
