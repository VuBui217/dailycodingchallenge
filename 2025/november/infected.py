"""
Link to problem: https://www.freecodecamp.org/learn/daily-coding-challenge/2025-11-02
...
def infected(days):
    ...
    for day in range(1, days+1):
        infected = 2 * infected
        if day % 3 == 0:
            patch = math.ceil(0.2 * infected) # round up so use math.ceil()
            infected -= patch
    return infected

print(infected(1)  )   #  should return 2
print(infected(3)  )   #  should return 6
print(infected(8)  )   #  should return 152
print(infected(17) )   #  should return 39808
print(infected(25) )   #  should return 5217638