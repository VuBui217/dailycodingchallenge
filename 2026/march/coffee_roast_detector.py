"""
Link to problem: https://www.freecodecamp.org/learn/daily-coding-challenge/2026-03-22
...
def detect_roast(beans):
    ...
    avg = sum(bean_map[bean] for bean in beans) / len(beans)
...
print(detect_roast("''-''''''-'-''--''''")) # should return "Light".
print(detect_roast(".'-''-''..'''.-.-''-")) # should return "Medium".
print(detect_roast("--.''--'-''.--..-.--")) # should return "Medium".
print(detect_roast("-...'-......-..-...-")) # should return "Dark".
print(detect_roast(".--.-..-......----.'")) # should return "Medium".
print(detect_roast("..-..-..-..-....-.-.")) # should return "Dark".
print(detect_roast("-'-''''''..-'.''-'.'")) # should return "Light".