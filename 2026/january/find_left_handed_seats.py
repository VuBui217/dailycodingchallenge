"""
Docstring for 2026.january.find_left_handed_seats
Link to problem: https://www.freecodecamp.org/learn/daily-coding-challenge/2026-01-03
...
def find_left_handed_seats(table):
    ...
    for i in range(4):
        ...
        # Row facing down
        if table[0][i] == "U":
            if i == 3 or table[0][i+1] != "R":
                res += 1
    return res
print(find_left_handed_seats([["U", "R", "U", "L"], ["U", "R", "R", "R"]])) # should return 2.
print(find_left_handed_seats([["U", "U", "U", "U"], ["U", "U", "U", "U"]])) # should return 8.
print(find_left_handed_seats([["U", "R", "U", "R"], ["L", "R", "R", "U"]])) # should return 0.
print(find_left_handed_seats([["L", "U", "R", "R"], ["L", "U", "R", "R"]])) # should return 1.
print(find_left_handed_seats([["U", "R", "U", "U"], ["U", "U", "L", "U"]])) # should return 5.