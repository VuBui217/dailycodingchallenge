"""
Docstring for 2026.january.knights_move
Link to problem: https://www.freecodecamp.org/learn/daily-coding-challenge/2026-01-17
                        Knight Moves
...
def knight_moves(position):
    ...
    cols_map = {}
    for c in range(8):
        cols_map[chr(ord("A") + c)] = c
    
    row = rows_map[position[1]]
    col = cols_map[position[0]]
